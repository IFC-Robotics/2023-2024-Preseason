...
@Autonomous(name = "Red Range Auton", group = "Sensor")
...
//        Robot.drivetrain.strafe(-30,0.5);
    ...
    private void goToBackDrop() {
        Robot.drivetrain.drive(-5, 0.5);
        Robot.drivetrain.strafe(5, 0.5); // One of two lines of code that differ between the Red and Blue autonomous.
        Robot.drivetrain.drive(5, 0.5);
        Robot.drivetrain.turn(20, 0.5); // The second of two lines of code that differ between the Red and Blue autonomous.
