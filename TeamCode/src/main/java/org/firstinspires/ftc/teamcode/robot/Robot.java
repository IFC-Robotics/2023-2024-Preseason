...
//    public static TFModelClass redBlueModel;
    ...
    public static void init(LinearOpMode opMode) {
        ...
        servoDeposit =      new ServoClass("servo_deposit", "collect", 0.08, "score",0.5,"auton", 0.46, SERVO_SPEED, SERVO_TIME, false);
        servoLauncher =     new ServoClass("servo_launcher", "release", 0, "hold",0.5 ,"medium",1, SERVO_SPEED, SERVO_TIME, false);
