            ...
            if (Robot.mode == "FSM") {
                ...
                switch (state) {
                    ...
                    case ATTEMPT_TO_COLLECT:
                        if (gamepad2.x && liftIsntMoving(Robot.horizontalLift) && servoIsntMoving(Robot.servoRotateClaw)) {
                    ...
                    case TRANSFER_CONE:
                        if (gamepad2.x && servoIsntMoving(Robot.servoRotateClaw) && liftIsntMoving(Robot.horizontalLift)) {
