...
@TeleOp(name="old FSM teleOp", group="competition")
@Disabled
public class OldFSMteleOp extends LinearOpMode {
            ...
            if (Robot.mode == "FSM") {
                ...
                switch (state) {
                    ...
                    case MOVE_HORIZONTAL_TO_COLLECT:
                        if (!Robot.verticalLift.motorIsMoving) {
                    ...
                    case LOWER_CLAW:
                        if (!Robot.horizontalLift.motorIsMoving) {
//                            Robot.servoRotateClaw.runToPosition("collect"); // rotate claw down
                            timer.reset();
