...
//        leftPower = (drive + strafe + turn) / denominator ;
//        backLeftPower = (drive - strafe + turn) / denominator;
//        frontPower = (drive - strafe - turn) / denominator;
//        rightPower = (drive + strafe - turn) / denominator;
//
...
//        motorRight.setPower(frontLeftPower);
//        motorBack.setPower(backRightPower);
